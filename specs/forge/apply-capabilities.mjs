...
// Monta o manifesto a partir do conjunto resolvido (puro). `catalogHash` (opcional)
// carimba qual versão do catálogo (specs/baseline/capabilities.json) gerou o manifesto.
export function buildManifest({ app, stack, blocks, byId, catalogHash = null }) {
