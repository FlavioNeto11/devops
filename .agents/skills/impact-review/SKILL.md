---
name: impact-review
description: Analisa o impacto de uma mudança de requisito usando o mapa de impacto e a fila de reprocessamento — o que é afetado downstream (requisitos, ADRs, serviços, infra, testes) e o que exige atenção/reprocessamento do Codex. Use ao alterar um requisito ASR/major, ao avaliar uma proposta, ou ao priorizar trabalho.
...
- **Fila de reprocessamento** (`reprocess_queue`): requisitos de alto impacto OU com lacuna de
  verificação — o que o Codex deve revisar primeiro.
