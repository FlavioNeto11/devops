<!--
  AiAssistantView — Assistente de IA do ContaViva Pro (bloco control-ai-por-app).
...
-->
<template>
  <UiPageLayout eyebrow="ContaViva Pro · IA" title="Assistente" subtitle="Pergunte e, se quiser, anexe arquivos para a IA analisar." width="wide">
    <template #actions>
