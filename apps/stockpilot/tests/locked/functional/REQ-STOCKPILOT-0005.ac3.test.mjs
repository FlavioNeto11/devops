// LOCKED — gerado de REQ-STOCKPILOT-0005 / acceptance_criteria[2] por make-test-suite.mjs. NÃO EDITAR (mudar exige spec + regenerar).
import { test } from 'node:test';
import assert from 'node:assert/strict';
import { get, post, del, sleep, LIVE } from '../_lib.mjs';

test('REQ-STOCKPILOT-0005 AC3: Abas: Produtos | Pedidos | Alertas', { skip: LIVE ? false : 'sem BASE_URL (forge-tests)' }, async () => {
