// LOCKED — gerado de REQ-NEUROEVOLUI-0002 / acceptance_criteria[5] por make-test-suite.mjs. NÃO EDITAR (mudar exige spec + regenerar).
import { test } from 'node:test';
import assert from 'node:assert/strict';
import { get, post, del, sleep, LIVE } from '../_lib.mjs';

test('REQ-NEUROEVOLUI-0002 AC6: Soft-delete ativo para compliance', { skip: LIVE ? false : 'sem BASE_URL (forge-tests)' }, async () => {
