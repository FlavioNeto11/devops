// LOCKED — gerado de REQ-NEUROEVOLUI-0001 / acceptance_criteria[2] por make-test-suite.mjs. NÃO EDITAR (mudar exige spec + regenerar).
import { test } from 'node:test';
import assert from 'node:assert/strict';
import { get, post, del, sleep, LIVE } from '../_lib.mjs';

test('REQ-NEUROEVOLUI-0001 AC3: Todo SQL reside em repositories', { skip: LIVE ? false : 'sem BASE_URL (forge-tests)' }, async () => {
