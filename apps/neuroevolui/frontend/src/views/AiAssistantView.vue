<!--
  AiAssistantView — Assistente de IA do NeuroEvolui (bloco control-ai-por-app).
...
-->
<template>
  <UiPageLayout eyebrow="NeuroEvolui · IA" title="Assistente" subtitle="Pergunte e, se quiser, anexe arquivos para a IA analisar." width="wide">
    <template #actions>
