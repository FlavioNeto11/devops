// server.js — API (camadas: rotas finas). Servida em /valdemo/api (stripPrefix). Gerado pela Forge.
...
app.get('/', (_q, res) => res.json({ app: 'valdemo', service: 'api', ok: true }));
...
(async () => {
  ...
  startMetricsServer();
  app.listen(PORT, () => console.log('[valdemo-api] :' + PORT));
