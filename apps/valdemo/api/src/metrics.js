...
client.collectDefaultMetrics({ register: registry, prefix: 'valdemo_' });
export const M = {
  recordsTotal: new client.Counter({ name: 'valdemo_records_total', help: 'records por desfecho', labelNames: ['outcome'], registers: [registry] }),
  httpErrors: new client.Counter({ name: 'valdemo_http_errors_total', help: 'erros HTTP', registers: [registry] }),
};
