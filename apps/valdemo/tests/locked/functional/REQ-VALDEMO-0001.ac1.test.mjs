// LOCKED — gerado de REQ-VALDEMO-0001 / acceptance_criteria[0] por make-test-suite.mjs. NÃO EDITAR (mudar exige spec + regenerar).
import { test } from 'node:test';
import assert from 'node:assert/strict';
import { get, post, del, sleep, LIVE } from '../_lib.mjs';

test('REQ-VALDEMO-0001 AC1: /health responde ok', { skip: LIVE ? false : 'sem BASE_URL (forge-tests)' }, async () => {
