...
| 8 | H | ⚠️ Regulatory Watch (backend) + Centro Operacional da vertical (PR-H1) — fluxo de aprovação humana, `verificar-agora`, promoção administrativa e `GET .../operations/overview` entregues; frontend do fluxo humano e das telas de analytics seguem no PR-H2 | Ondas 1–6 |
