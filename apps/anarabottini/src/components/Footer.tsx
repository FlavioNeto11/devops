      ...
      <div className="container-wide grid gap-10 py-14 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1.1fr]">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm">
            <li>
              {mail ? (
                <a href={mail} className="flex items-center gap-2.5 text-brand-muted transition-colors hover:text-brand-neon">
            ...
            <li>
              {wa ? (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2.5 text-brand-muted transition-colors hover:text-brand-neon"
                >
