...
const field =
  'w-full rounded-xl border border-brand-text/12 bg-brand-surface px-4 py-2.5 text-sm text-brand-text placeholder:text-brand-muted/60 focus:border-brand-neon/50 focus:outline-none focus:ring-2 focus:ring-brand-neon/15';
