...
.tone-blue { color: var(--im-accent-3); background: rgba(56,189,248,0.13); }
.tone-danger { color: var(--im-danger); background: rgba(248,113,113,0.13); }
.tone-muted { color: var(--im-muted); background: rgba(147,168,173,0.12); }
</style>
