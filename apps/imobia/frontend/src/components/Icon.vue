<script setup>
// Conjunto de icones (stroke) inline — CSP-safe, sem libs externas.
defineProps({ name: { type: String, required: true }, size: { type: [Number, String], default: 18 } });
const P = {
  dashboard: 'M3 3h8v8H3zM13 3h8v5h-8zM13 10h8v11h-8zM3 13h8v8H3z',
  building: 'M3 21h18M5 21V7l7-4 7 4v14M9 9h.01M12 9h.01M15 9h.01M9 13h.01M12 13h.01M15 13h.01M10 21v-4h4v4',
  ...
  bank: 'M3 21h18M4 10h16M5 6l7-3 7 3M6 10v8M10 10v8M14 10v8M18 10v8',
