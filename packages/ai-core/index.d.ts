...
export function createGeminiLlm(client: unknown, opts?: { defaultModel?: string; defaultMaxTokens?: number }): LlmAdapter;
...
export function toGeminiContents(messages: Array<Record<string, unknown>>): { systemInstruction: string; contents: Array<Record<string, unknown>> };
export function toGeminiToolConfig(toolChoice?: unknown): Record<string, unknown>;
